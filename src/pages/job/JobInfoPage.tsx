...
*/
const JobInfoPage: React.FC<{ parentJobId: number; onUpdateJobId: (newJobId: number) => void }> = ({ parentJobId, onUpdateJobId }) => {
        ...
        <Box component="form" noValidate autoComplete="off">
            <Grid container spacing={2}>
                ...
                <Grid item xs={3} sm={3} md={3} lg={3} xl={3}>
                    <TextField type="number" fullWidth id="minimumSalary" name="minimumSalary" label="Minimum  Salary" variant="outlined"
                        inputProps={{ maxLength: 200 }}
                        helperText={
                            utility.errorInfo.find(
                ...
                <Grid item xs={3} sm={3} md={3} lg={3} xl={3}>
                    <TextField fullWidth id="maximumSalary" name="maximumSalary" label="Maximum  Salary" variant="outlined"
                        inputProps={{ maxLength: 200 }}
