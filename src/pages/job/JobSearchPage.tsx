import { Accordion, AccordionSummary, Autocomplete, Box, Button, Card, CardContent, Checkbox, FormControl, Grid, InputLabel, MenuItem, Select, TextField } from "@mui/material";
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} md={4}>
                                    <FormControl fullWidth >
                                        ...
                                        >
                                            <MenuItem key={0} value={0}>Designation</MenuItem>
                                ...
                                <Grid item xs={12} md={4}>
                                    <FormControl fullWidth >
                                        ...
                                        <Select
                                            ...
                                            onChange={utility.onSelectFieldChanged}
                                        >
                                            <MenuItem key={0} value={0}>Experience</MenuItem>
                                ...
                                <Grid item xs={3} sm={3} md={3} lg={3} xl={3}>
                                    <FormControl fullWidth>
                                        ...
                                        <Select
                                            ...
                                            onChange={utility.onSelectFieldChanged}
                                        >
                                            <MenuItem key={0} value={0}>Train Line</MenuItem>
                    ...
                    <Card>
                        <CardContent>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12}>
                                    <Typography gutterBottom sx={{ color: 'text.secondary', fontSize: 10, width: "90%" }}>

                                        <div className="content" dangerouslySetInnerHTML={{ __html: job.jobDescription }}></div>
                                    </Typography>
                                </Grid>
                                <Grid item xs={12}>
                                    <Typography gutterBottom sx={{ color: 'text.secondary', fontSize: 10, width: "90%" }}>
                                ...
                                <Grid item xs={12}>
                                    <Typography gutterBottom sx={{ color: 'text.secondary', fontSize: 10, width: "90%" }}>
                                        ...
                                        Company Name :  {job.companyName}   {job.companyEmailAddress}   {job.companyMobileNo}
                                    </Typography>
                                </Grid>

                                <Grid item xs={12}>
                                    <Button variant="contained" onClick={()=> jobApplicationUtility.onApplyJob(job.id)}>Apply</Button>
                                </Grid>
