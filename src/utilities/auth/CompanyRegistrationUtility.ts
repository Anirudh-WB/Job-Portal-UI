...
const CompanyRegistrationUtility = () => {
    ...
    const [companyRegistration, setCompanyRegistration] = useState<CompanyRegistrationModel>(initialCompanyRegistration);
    ...
    const onCompanyRegistration = async () => {
        ...
        if (isValidate()) {
            ...
            const response = await createCompanyRegistrationAsync(companyRegistration);
    ...
    const isValidate = () => {
        ...
        if (companyRegistration.confirmPassword !== "" && companyRegistration.password !== "") {
    ...
    return {
        companyRegistration, onCompanyRegistration, onTextFieldChange, errorInfo,
