...
const JobSearchUtility = () => {
  ...
  const [jobSearchResult, setJobSearchResult] = useState<JobSearchResultModel[]>();
  ...
  return { selectedSkills, onSkillChange, test, selectedCities, onCityChange, onSelectFieldChanged, experiances, jobSearchField, jobSearchResult }
